				...
				success: function(result){
					$.each(result, function(k,v){
						if(Math.round(v['balance'])>0){
							var html="<tr>";
							html+= "<td width='17%'><input type='text' class='form-control' value="+v['prefix']+""+v['Sal_inv_no']+" disabled><input type='hidden' name='invoice_nos[]' class='form-control' value="+v['Sal_inv_no']+"><input type='hidden' name='totalInvoices' class='form-control' value="+counter+"><input type='hidden' name='prefix[]' class='form-control' value="+v['prefix']+"></td><td width='14%'>" + (v['nop'] ? v['nop'] : "") + "</td>"
