                ...
                $.each(result, function(k, v) {
                    if (Math.round(v['balance']) > 0) {
                        ...
                        html += "<td width='18%'>" +
                            ...
                            "<input type='hidden' name='invoice_nos[]' class='form-control' value='" + v['Sal_inv_no'] + "'>" +
                            "<input type='hidden' name='totalInvoices' class='form-control' value='" + counter + "'>" +
                            "<input type='hidden' name='prefix[]' class='form-control' value='" + v['prefix'] + "'>" +
                            "</td>";
                        html += "<td width='15%'>" + v['sa_date'] + 
                            "<input type='hidden' class='form-control' value='" + v['sa_date'] + "'></td>";
                        html += "<td width='20%'>" +
                            "<input type='number' class='form-control' value='" + Math.round(v['b_amt']) + "' disabled>" +
                            "<input type='hidden' name='balance_amount[]' class='form-control' value='" + Math.round(v['b_amt']) + "'>" +
                            "</td>";
                        html += "<td width='20%'>" +
                            "<input type='number' class='form-control text-danger' value='" + Math.round(v['balance']) + "' disabled>" +
                            "<input type='hidden' name='bill_amount[]' class='form-control' value='" + Math.round(v['bill_balance']) + "'>" +
                            "</td>";
                        html += "<td width='20%'>" +
                            "<input type='number' class='form-control' value='0' max='" + Math.round(v['balance']) + "' step='any' name='rec_amount[]' onchange='totalReci()' required>" +
                            "</td>";
                        html += "</tr>";
