				...
				<section role="main" class="content-body">
                    ...
                    <div class="tabs">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link nav-link-rep" data-bs-target="#SALE1" href="#SALE1" data-bs-toggle="tab">Sale1</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link nav-link-rep" data-bs-target="#PURCHASE1" href="#PURCHASE1" data-bs-toggle="tab">Purchase1</a>
                            </li>
                        </ul>
